<template>
    <div class="game">
        ...
        <svg id="scene" viewBox="0 0 1250 650" height="650">
            ...
            <HelpButton transform="translate(1200, 55)" :isOn="preferences.help" @click="toggleHelp()" />
            ...
            <template v-if="preferences.help">
...
export default class Game extends Vue {
    ...
    toggleHelp() {
        this.preferences.help = !this.preferences.help;
    }
